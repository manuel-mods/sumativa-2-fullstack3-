...
export class ForumService {
  ...
  private mockCategories: Category[] = [
    {
      id: '1',
      name: 'Programming',
      description: 'Discuss programming languages, frameworks, and coding practices',
    ...
    },
    {
      id: '2',
      name: 'Gaming',
      description: 'Gaming discussion, news, and recommendations',
    ...
    },
    {
      id: '4',
      name: 'Movies & TV',
      description: 'Discuss your favorite shows, films, and streaming content',
    ...
    },
    {
      id: '5',
      name: 'Music',
      description: 'Share your favorite artists, albums, and music recommendations',
  ...
  getTopicsByCategory(categoryId: string): Topic[] {
    return this.topicsSignal().filter(t => t.categoryId === categoryId && !t.isBanned);
  }
  ...
  createTopic(title: string, content: string, categoryId: string): Topic | null {
  ...
  deleteTopic(topicId: string): void {
    ...
    const updatedComments = comments.filter(comment => comment.topicId !== topicId);
  ...
  private updateCategoryTopicCount(categoryId: string): void {
    const topics = this.topicsSignal().filter(t => t.categoryId === categoryId && !t.isBanned);
  ...
  private saveCommentsToStorage(): void {
    localStorage.setItem(this.COMMENTS_KEY, JSON.stringify(this.commentsSignal()));
  }
